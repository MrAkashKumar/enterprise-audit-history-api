...
public record AuditApiProperties(String auditSuffix, String idColumn, String auditOrderColumn,
    ...
    public AuditApiProperties {
        auditSuffix = valueOrDefault(auditSuffix, AUDIT_SUFFIX).toUpperCase();
        idColumn = valueOrDefault(idColumn, ID_COLUMN).toUpperCase();
        auditOrderColumn = valueOrDefault(auditOrderColumn, REVISION_COLUMN).toUpperCase();
        revisionTypeColumn = valueOrDefault(revisionTypeColumn, REVISION_TYPE_COLUMN).toUpperCase();
