...
import com.akash.auditapi.model.ApiResponse;
import com.akash.auditapi.model.PageResponse;
...
import static com.akash.auditapi.config.ApiPaths.V1;
import static com.akash.auditapi.config.ApiPaths.HOLIDAYS;
import static com.akash.auditapi.config.ApiPaths.RESOURCE_ID;
import static com.akash.auditapi.config.AuditDefaults.DEFAULT_PAGE_NUMBER_TEXT;
import static com.akash.auditapi.config.AuditDefaults.DEFAULT_PAGE_SIZE_TEXT;
...
public class HolidayController {
    ...
    public ResponseEntity<ApiResponse<HolidayResponse>> create(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.created(data, REQUEST_SUCCESSFUL));
    }
